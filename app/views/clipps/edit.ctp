...
<?php echo $this->Form->create('Clipp');?>
	<fieldset>
		<legend><?php __('Edit Clipp'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Clipp.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Clipp.id'))); ?></li>
